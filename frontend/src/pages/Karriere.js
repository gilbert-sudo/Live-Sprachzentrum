    ...
    <>
      ...
      <div className="max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop pt-6 md:pt-10 space-y-8">
        ...
        <section className="relative rounded-2xl overflow-hidden bg-germany-black text-white ambient-shadow-lvl2">
          ...
          <div className="relative p-6 sm:p-8 md:p-12 flex flex-col md:flex-row items-center justify-between md:gap-8 z-10">
            <div className="space-y-4 max-w-xl relative z-10 mt-4 md:mt-0">
              <span className="inline-block px-3 py-1 rounded-full bg-germany-red text-white font-label-sm text-label-sm uppercase tracking-wider shadow-sm">Objectif Ausbildung & Karriere</span>
              <h1 className="font-display-lg text-display-lg md:text-[56px] leading-tight text-white drop-shadow-sm">Dein Weg nach <span className="text-germany-gold">Deutschland</span> starts here.</h1>
            ...
            <div className="absolute md:relative -right-16 -top-16 md:right-auto md:top-auto md:w-1/3 flex justify-center opacity-10 md:opacity-100 pointer-events-none md:pointer-events-auto">
              <div className="w-64 h-64 md:w-48 md:h-48 bg-white/10 md:bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/5 md:border-white/20">
                <span className="material-symbols-outlined text-[140px] md:text-[80px] text-germany-gold font-light">flight_takeoff</span>
              </div>
            </div>
          </div>
