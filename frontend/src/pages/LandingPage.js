  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-germany-black text-slate-900 dark:text-white overflow-x-hidden font-sans relative transition-colors duration-500">
      ...
      <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col space-y-4">
        <a href="https://www.facebook.com/p/Live-Sprachzentrum-LIS-100076350932625/" target="_blank" rel="noopener noreferrer" className="relative group w-12 h-12 rounded-full bg-white dark:bg-white/10 backdrop-blur-md shadow-[0_5px_20px_rgba(0,0,0,0.12)] dark:shadow-2xl border border-slate-200 dark:border-white/20 flex items-center justify-center text-blue-600 dark:text-blue-400 hover:scale-110 hover:-translate-x-1 transition-all duration-300 hover:shadow-blue-500/20">
        ...
        <a href="https://www.instagram.com/livesprachzentrum/" target="_blank" rel="noopener noreferrer" className="relative group w-12 h-12 rounded-full bg-white dark:bg-white/10 backdrop-blur-md shadow-[0_5px_20px_rgba(0,0,0,0.12)] dark:shadow-2xl border border-slate-200 dark:border-white/20 flex items-center justify-center text-pink-600 dark:text-pink-400 hover:scale-110 hover:-translate-x-1 transition-all duration-300 hover:shadow-pink-500/20">
        ...
        <a href="https://wa.me/261349398689" target="_blank" rel="noopener noreferrer" className="relative group w-12 h-12 rounded-full bg-white dark:bg-white/10 backdrop-blur-md shadow-[0_5px_20px_rgba(0,0,0,0.12)] dark:shadow-2xl border border-slate-200 dark:border-white/20 flex items-center justify-center text-green-600 dark:text-green-400 hover:scale-110 hover:-translate-x-1 transition-all duration-300 hover:shadow-green-500/20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 px-6 py-3 rounded-[2rem] sm:rounded-full bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-slate-200/50 dark:border-white/10 shadow-lg dark:shadow-xl">
            <div className="flex items-center space-x-3">
              {/* Madagascar Flag */}
              <div className="w-8 h-5 rounded-[3px] overflow-hidden shadow-sm flex border border-black/10 dark:border-white/10 shrink-0">
                <div className="w-[33.33%] h-full bg-white"></div>
                <div className="w-[66.67%] h-full flex flex-col">
                  <div className="w-full h-1/2 bg-[#fc3d32]"></div>
                  <div className="w-full h-1/2 bg-[#007e3a]"></div>
                </div>
              </div>
              ...
              >
                <Plane className="w-4 h-4 text-amber-600/70 dark:text-germany-gold/70 transform rotate-45" />
              </motion.div>
              
              {/* Germany Flag */}
              <div className="w-8 h-5 rounded-[3px] overflow-hidden shadow-sm flex flex-col border border-black/10 dark:border-white/10 shrink-0">
                <div className="w-full h-[33.33%] bg-black"></div>
                <div className="w-full h-[33.33%] bg-[#DD0000]"></div>
                <div className="w-full h-[33.33%] bg-[#FFCE00]"></div>
              </div>
            </div>
